  ...
  <div class="content-wrapper" v-loading="loading">
    <section class="content-header">
      <h1 class="label bg-primary">
        Mis Expedientes
        <small style="color: white">Sistema de Expedientes Activos</small>
      </h1>
    </section>
    <br />
    <section class="content" v-loading="loading">
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
          <ol class="label breadcrumb bg-gray pull-right">
            ...
            <router-link tag="li" to="/exp_mis_expedientes" exact>
              <i class="fa fa-dashboard"></i> Activos
            </router-link>
          </ol>
        </div>
        ...
        :opcion="1"
        :actuacion="actuacion" :fields="fields" :expediente_id="expediente_id" :numero_expediente="numero_expediente" :tipo_tramite="tipo_tramite"
        ></tabla_mis_expedientes>
