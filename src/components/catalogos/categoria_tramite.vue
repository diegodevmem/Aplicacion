  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="label breadcrumb bg-gray">
        ...
        <li><i class="fa fa-bug active"></i> Categoría Trámite</li>
      </ol>
    </section>
    <br />
          ...
          <div :class="color"  id="p0">
            ...
            <div class="box-body">
              <form role="form" autocomplete="off">
                ...
                <div class="form-group">
                  <enhanced-check
                    :label="form.necesita_padre ? 'PUEDE TENER ASOCIACIONES' : 'NO PUEDE TENER ASOCIACIONES'"
                    subClass="success"
                    :animate="true"
                    :inline="false"
                    v-model="form.necesita_padre"
                    v-validate="'required'"
            ...
            <div class="panel-body table-responsive" id="listadoregistros">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  ...
                  >
                    <!-- A virtual column -->
                    <template slot="necesita_padre" slot-scope="data">
                      <h5 v-text="data.item.necesita_padre ? 'SI' : 'NO'"></h5>
                    </template>
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "necesita_padre", label: "Tiene Asociación", sortable: true },
  ...
  methods: {
    ...
    mapData(data) {
      ...
      self.form.necesita_padre = data.necesita_padre;
    },
