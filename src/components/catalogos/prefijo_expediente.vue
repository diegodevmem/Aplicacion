  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="label breadcrumb bg-gray">
        ...
        <li><i class="fa fa-bug active"></i> Prefijo Expediente</li>
      </ol>
    </section>
    <br />
              ...
              <form role="form" autocomplete="off">
                <div class="form-group">
                  ...
                  <input
                    ...
                    name="nombre"
                    v-validate="'required|min:3|max:20|regex:^[A-Za-z-][A-Za-z0-9-]*$'"
                ...
                <div class="form-group">
                  <label for="tipo_tramite_id">Tipo Trámite</label>
                  <multiselect
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "tipo_tramite.nombre", label: "Tipo Trámite", sortable: true },
      ...
      // DGH-LIC-OEGL-000005-2021
      // DGH-LIC-OIPN-000007-2021
  ...
  methods: {
    ...
    getPromise() {
      this.loading = true;
      Promise.all([this.getAll(), this.getTipoTramite()])
        .then(() => {
          this.loading = false;
        })
        .catch((error) => {
    ...
    getAll() {
      ...
      self.$store.state.services.prefijoexpedienteService
        .getAll()
        .then((r) => {
          self.loading = false;
      ...
      self.$store.state.services.tipotramiteService
        ...
        .then((r) => {
          r.data.data.forEach((element) => {
            if (!element.deleted_at) self.tipo_tramite.push(element);
          });
        })
    ...
    mapData(data) {
      ...
      self.form.tipo_tramite_id = data.tipo_tramite;
    },
