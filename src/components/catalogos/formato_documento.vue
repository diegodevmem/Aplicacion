  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="label breadcrumb bg-gray">
        ...
        <li><i class="fa fa-bug active"></i> Formato Documento</li>
      </ol>
    </section>
    <br />
              ...
              <form role="form" autocomplete="off">
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    id="formato"
                    placeholder="escribir el formato"
                    name="formato"
                    v-validate="'required|min:4|max:10|regex:^([.]+[A-Z]+)$'" 
                    :class="{ input: true, 'has-errors': errors.has('formato') }"
                    @input="form.formato = $event.target.value.toUpperCase()"
                  />
                  <FormError :attribute_name="'formato'" :errors_form="errors">
                  </FormError>
                </div>
              </form>
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "formato", label: "Formato", sortable: true },
  ...
  methods: {
    ...
    mapData(data) {
      ...
      self.form.formato = data.formato;
    },
